...
%global ironic_commit           master
%global manila_commit           master
%global redis_commit            master
%global timezone_commit         master
%global ipa_commit              master
%global module_collectd_commit  master
%global n1k_vsm_commit          master
%global nagios_commit           master
%global ntp_commit              master
%global trove_commit            master
...
Source1:    https://github.com/aimonb/puppet_aviator/archive/%{aviator_commit}/aviator-%{aviator_commit}.tar.gz
Source2:    https://github.com/stackforge/puppet-ceilometer/archive/%{ceilometer_commit}/ceilometer-%{ceilometer_commit}.tar.gz
Source3:    https://github.com/rcritten/puppet-certmonger/archive/%{certmonger_commit}/certmonger-%{certmonger_commit}.tar.gz
Source4:    https://github.com/stackforge/puppet-cinder/archive/%{cinder_commit}/cinder-%{cinder_commit}.tar.gz
Source5:    https://github.com/purpleidea/puppet-common/archive/%{common_commit}/common-%{common_commit}.tar.gz
Source6:    https://github.com/puppetlabs/puppetlabs-concat/archive/%{concat_commit}/concat-%{concat_commit}.tar.gz
Source7:    https://github.com/puppetlabs/puppetlabs-firewall/archive/%{firewall_commit}/firewall-%{firewall_commit}.tar.gz
Source8:    https://github.com/redhat-openstack/puppet-galera/archive/%{galera_commit}/galera-%{galera_commit}.tar.gz
Source9:    https://github.com/stackforge/puppet-glance/archive/%{glance_commit}/glance-%{glance_commit}.tar.gz
Source10:   https://github.com/purpleidea/puppet-gluster/archive/%{gluster_commit}/gluster-%{gluster_commit}.tar.gz
Source11:   https://github.com/puppetlabs/puppetlabs-haproxy/archive/%{haproxy_commit}/haproxy-%{haproxy_commit}.tar.gz
Source12:   https://github.com/stackforge/puppet-heat/archive/%{heat_commit}/heat-%{heat_commit}.tar.gz
Source13:   https://github.com/stackforge/puppet-horizon/archive/%{horizon_commit}/horizon-%{horizon_commit}.tar.gz
Source14:   https://github.com/puppetlabs/puppetlabs-inifile/archive/%{inifile_commit}/inifile-%{inifile_commit}.tar.gz
...
Source29:   https://github.com/puppetlabs/puppetlabs-ntp/archive/%{ntp_commit}/ntp-%{ntp_commit}.tar.gz
Source30:   https://github.com/stackforge/puppet-openstack/archive/%{openstack_commit}/openstack-%{openstack_commit}.tar.gz
Source31:   https://github.com/stackforge/puppet-openstacklib/archive/%{openstacklib_commit}/openstacklib-%{openstacklib_commit}.tar.gz
Source32:   https://github.com/redhat-openstack/puppet-pacemaker/archive/%{pacemaker_commit}/pacemaker-%{pacemaker_commit}.tar.gz
Source33:   https://github.com/purpleidea/puppet-puppet/archive/%{puppet_commit}/puppet-%{puppet_commit}.tar.gz
...
Source43:   https://github.com/puppetlabs/puppetlabs-sysctl/archive/%{sysctl_commit}/sysctl-%{sysctl_commit}.tar.gz
Source44:   https://github.com/stackforge/puppet-tempest/archive/%{tempest_commit}/tempest-%{tempest_commit}.tar.gz
Source45:   https://github.com/saz/puppet-timezone/archive/%{timezone_commit}/timezone-%{timezone_commit}.tar.gz
Source46:   https://github.com/stackforge/puppet-trove/archive/%{trove_commit}/trove-%{trove_commit}.tar.gz
Source47:   https://github.com/puppetlabs/puppetlabs-vcsrepo/archive/%{vcsrepo_commit}/vcsrepo-%{vcsrepo_commit}.tar.gz
Source48:   https://github.com/derekhiggins/puppet-vlan/archive/%{vlan_commit}/vlan-%{vlan_commit}.tar.gz
Source49:   https://github.com/stackforge/puppet-vswitch/archive/%{vswitch_commit}/vswitch-%{vswitch_commit}.tar.gz
Source50:   https://github.com/puppetlabs/puppetlabs-xinetd/archive/%{xinetd_commit}/xinetd-%{xinetd_commit}.tar.gz
...
find %{_builddir}/%{name}-%{version}/ \( -name "*.rb" -o -name "*.erb" \) -exec chmod -x {} +
...
cp -r puppetlabs-ntp-%{ntp_commit} %{buildroot}/%{_datadir}/openstack-puppet/modules/ntp
...
cp -r puppet-trove-%{trove_commit} %{buildroot}/%{_datadir}/openstack-puppet/modules/trove
